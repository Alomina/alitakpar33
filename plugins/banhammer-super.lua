  ...
  if msg.action and msg.action.type then
    ...
    if action == 'chat_add_user' or action == 'chat_add_user_link' then
      ...
      if banned then
        ...
        channel_kick_user("channel#id"..msg.to.id, 'user#id'..user_id, ok_cb, false)
  ...
  if msg.to.type == 'channel' then
    ...
    if banned then
     ...
     -- ban_user(user_id, chat_id)
      channel_kick_user("channel#id"..msg.from.id, 'user#id'..user_id, ok_cb, false)
      msg.text = ''
    end
  end
  ...
  if matches[1] == 'ban' then
    ...
    if msg.to.type == 'channel' then
      if matches[2] == 'user' then
        ...
        channel_kick_user("channel#id"..msg.to.id, 'user#id'..matches[3], ok_cb, false)
        --ban_user(user_id, chat_id)
  ...
  if matches[1] == 'kick' then
   -- if msg.to.type == 'chat' or msg.to.type == 'channel' then
    if msg.to.type == 'channel' then
      ...
      return 'This isn\'t a SUPER Group'
    end
  end
